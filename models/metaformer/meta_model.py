...
from models.metaformer.net.downsampler_net import Model_Net
from models.metaformer.post.identity_head import Model_Post
from models.metaformer.emb.sine_pos import Model_Emb
...
class MetaFormer(nn.Module):
    def __init__(
        ...
        self.embedding_block = Model_Emb(**emb_params)
        self.network_block = Model_Net(**net_params)
        self.post_block = Model_Post(**post_params)
